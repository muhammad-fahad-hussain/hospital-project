    ...
    <main class="mt-5 pt-5 ">
        <div class="container-fluid ">
            <div class="container">
                ...
                <div class="row mx-5">
                    ...
                    <?php
                        // <!-- query -->
                    $q = "SELECT s.speciality_name, d.name, d.contact,  d.image, d.experience  FROM
                     doctor AS d 
                     INNER JOIN speciality AS s ON s.speciality_id = d.speciality_id 
                     WHERE d.doctor_id  in(SELECT  r.doctor_id FROM report_patient AS r 
                     WHERE r.patient_id = '$patient_no' GROUP BY r.doctor_id ) ";
                    ...
                    if (mysqli_num_rows($res) > 0) {
                        ...
                        foreach ($res as $r) {
                            ...
                            <div class="p-3">
                <img src="data:image/jpeg;base64,' . base64_encode($r['image']) . '" alt="Doctor Image" class="img-fluid" style="border:black 1px solid;">
            </div>
        </div>
        ...
        <div class="col-md-6 mb-5">
            <div class="card " style="border: none ;">
                <div class="card-body">
                    <p class="text-primary">' . $r['speciality_name'] . '</p>
                    <p class="text-primary display-5">Dr. <span>' . $r['name'] . '</span></p>
                    <h3 class="card-title mt-3">Experience</h3>
                    <p class="border p-3">More than ' . $r['experience'] . ' Years</p>
                    <h3 class="mt-3 mb-4">Contact <span class="text-muted mb-3" style="font-size: small;">(Only for Emergency)</span></h3>
                    <a href="tel:03002233111" class="border mt-3 p-3 text-decoration-none text-dark">' . $r['contact'] . '</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
                        ...
                        echo "<h2>You don't have a doctor</h2>";
                    }
                    ?>
