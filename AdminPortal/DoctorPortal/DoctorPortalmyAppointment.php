            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="row row-cols-1 row-cols-lg-2 p-5 pt-0">
                        <div class="col mt-3">
                            <div class="card w-75">
                                <p class="card-header text-muted">8:30 AM</p>
                                <div class="card-body">
                                    <h6 class=""><span>Patient name</span>, <span>30</span></h6>
                                    <p class="text-muted pt-0">Flu</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="/DoctorPortal/messagedoctor.html" class="call"><i class="far fa-envelope-open-text"
                        ...
                        <div class="col mt-3">
                            <div class="card w-75">
                                <p class="card-header text-muted">9:00 AM</p>
                                <div class="card-body">
                                    <h6 class=""><span>Patient name</span>, <span>30</span></h6>
                                    <p class="text-muted pt-0">Flu</p>
                                    <div class="row">
                        ...
                        <div class="col mt-3">
                            <div class="card w-75">
                                <p class="card-header text-muted">9:30 AM</p>
                                <div class="card-body">
                                    <h6 class=""><span>Patient name</span>, <span>30</span></h6>
                                    <p class="text-muted pt-0">Flu</p>
                                    <div class="row">
                        ...
                        <div class="col mt-3">
                            <div class="card w-75">
                                <p class="card-header text-muted">10:00 AM</p>
                                <div class="card-body">
                                    <h6 class=""><span>Patient name</span>, <span>30</span></h6>
                                    <p class="text-muted pt-0">Flu</p>
                                    <div class="row">
                        ...
                        <div class="col mt-3">
                            <div class="card w-75">
                                <p class="card-header text-muted">10:30 AM</p>
                                <div class="card-body">
                                    <h6 class=""><span>Patient name</span>, <span>30</span></h6>
                                    <p class="text-muted pt-0">Flu</p>
                                    <div class="row">
                        ...
                        <div class="col mt-3">
                            <div class="card w-75">
                                <p class="card-header text-muted">11:00 AM</p>
                                <div class="card-body">
                                    <h6 class=""><span>Patient name</span>, <span>30</span></h6>
                                    <p class="text-muted pt-0">Flu</p>
                                    <div class="row">
